...
public class IpAddress implements Serializable {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "idIpAddress")
	@SequenceGenerator(name="idIpAddress", sequenceName = "ip_address_id_ip_address_seq", allocationSize=1)
	@Column(name="id_ip_address")
	private Long idIpAddress;

	@JsonIgnore 
	@OneToMany(mappedBy = "ipAddress", fetch = FetchType.LAZY) 
	@NotAudited
