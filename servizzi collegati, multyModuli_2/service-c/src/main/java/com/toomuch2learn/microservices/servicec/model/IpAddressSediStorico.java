...
/**
 * The persistent class for the ip_address_sedi_storico database table.
 * 
 */
@Entity
@Table(name="ip_address_sedi_storico")
@NamedQuery(name="IpAddressSediStorico.findAll", query="SELECT i FROM IpAddressSediStorico i")
public class IpAddressSediStorico implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "idIpAddressSediStorico")
	@SequenceGenerator(name="idIpAddressSediStorico", sequenceName = "ip_address_sedi_storico_id_ip_address_sedi_storico_seq", allocationSize=1)
	@Column(name="id_ip_address_sedi_storico")
	private Long idIpAddressSediStorico;
	...
	public IpAddressSediStorico() {
	}

	public Long getIdIpAddressSediStorico() {
		return this.idIpAddressSediStorico;
	}

	public void setIdIpAddressSediStorico(Long idIpAddressSediStorico) {
		this.idIpAddressSediStorico = idIpAddressSediStorico;
	}
